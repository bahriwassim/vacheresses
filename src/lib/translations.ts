...
export const translations: Record<Locale, Translation> = {
  en: {
    ...
    packages: {
        ...
        subtitle: "Complete formulas for an unforgettable celebration, from venue privatization to prestige services.",
        selectDatesInfo: "Select a date above or choose a package to select your event date",
        selectAndContinue: "Select date & continue",
        formule1_title: "Wedding Formula 1 (Weekend)",
        formule1_desc: "The full experience from Friday to Sunday for an exceptional wedding.",
        formule1_price: "From €29,750",
        formule1_features: [
          "Venue privatization (Fri 2pm to Sun)",
          "Accommodation for 21 people (2 nights)",
          "Catering & Staff included (base 80 guests)",
          "DJ & Photographer included",
          "Decor, furniture & AC included",
        ],
        formule2_title: "Wedding Formula 2 (Weekday)",
        formule2_desc: "An elegant weekday celebration, available in high season.",
        formule2_price: "From €27,750",
        formule2_features: [
          "Weekday venue privatization",
          "Accommodation for 21 people (1 or 2 nights)",
          "Catering & Staff included (base 80 guests)",
          "DJ & Photographer included",
          "Full estate access, pool & tennis",
        ],
  ...
  fr: {
    ...
    packages: {
        ...
        subtitle: "Des formules complètes pour une célébration inoubliable, de la privatisation du domaine aux services de prestige.",
        ...
        formule1_title: "Mariage Formule 1 (Week-end)",
        formule1_desc: "L'expérience complète du vendredi au dimanche pour un mariage d'exception.",
        formule1_price: "À partir de 29 750 €",
        formule1_features: [
          "Privatisation du domaine (Ven 14h au Dim)",
          "Hébergement pour 21 personnes (2 nuits)",
          "Traiteur & Personnel inclus (base 80 pers.)",
          "DJ & Photographe inclus",
          "Décoration, mobilier & clim inclus",
        ],
        formule2_title: "Mariage Formule 2 (Semaine)",
        formule2_desc: "Une célébration élégante en semaine, disponible en haute saison.",
        formule2_price: "À partir de 27 750 €",
        formule2_features: [
          "Privatisation du domaine en semaine",
          "Hébergement pour 21 personnes (1 ou 2 nuits)",
          "Traiteur & Personnel inclus (base 80 pers.)",
          "DJ & Photographe inclus",
